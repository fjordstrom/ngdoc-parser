 ...
 * @constructor
 */
function DocCommentParser(text, extra_opts) {


   if(typeof(extra_opts)!=="undefined" && extra_opts!==null) {
       if(Array.isArray(extra_opts)) {
           extra_opts.map(function (item) {
               if (typeof(tagDefMap[item]) !== 'undefined')
                   return;
               tagDefMap[item] = {};
               return;
           });
